...
CREATE TABLE "Notification" (
    ...
    "notifiactionStatus" "notificationStatus" NOT NULL DEFAULT 'unread',
    "createdAt" DATE NOT NULL,
    "userID" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "JobPost_notificatioID_key" ON "JobPost"("notificatioID");
...
-- AddForeignKey
ALTER TABLE "JobPost" ADD CONSTRAINT "JobPost_notificatioID_fkey" FOREIGN KEY ("notificatioID") REFERENCES "Notification"("notification") ON DELETE CASCADE ON UPDATE CASCADE;
