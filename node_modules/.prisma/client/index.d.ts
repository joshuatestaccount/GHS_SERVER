...
export namespace Prisma {
  ...
  */
  ...
  export type LogsCountOutputTypeGetPayload<S extends boolean | null | undefined | LogsCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type CompanyCountOutputTypeGetPayload<S extends boolean | null | undefined | CompanyCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type EndorsementCountOutputTypeGetPayload<S extends boolean | null | undefined | EndorsementCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type JobPostCountOutputTypeGetPayload<S extends boolean | null | undefined | JobPostCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type UserSelect = {
    ...
    Endorse?: boolean | EndorseFindManyArgs
    Endorsement?: boolean | EndorsementFindManyArgs
    Feedback?: boolean | FeedbackArgs
    interviewer?: boolean | InterviewerFindManyArgs
    JobPost?: boolean | JobPostFindManyArgs
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'Comment' ? CommentGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'Endorsement' ? Array < EndorsementGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'Feedback' ? FeedbackGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'interviewer' ? Array < InterviewerGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'JobPost' ? Array < JobPostGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        ...
        P extends 'Logs' ? Array < LogsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'Comment' ? CommentGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'Endorsement' ? Array < EndorsementGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'Feedback' ? FeedbackGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'interviewer' ? Array < InterviewerGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'JobPost' ? Array < JobPostGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        ...
        P extends 'Logs' ? Array < LogsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Endorse<T extends EndorseFindManyArgs= {}>(args?: Subset<T, EndorseFindManyArgs>): PrismaPromise<Array<EndorseGetPayload<T>>| Null>;

    Endorsement<T extends EndorsementFindManyArgs= {}>(args?: Subset<T, EndorsementFindManyArgs>): PrismaPromise<Array<EndorsementGetPayload<T>>| Null>;

    Feedback<T extends FeedbackArgs= {}>(args?: Subset<T, FeedbackArgs>): Prisma__FeedbackClient<FeedbackGetPayload<T> | Null>;

    interviewer<T extends InterviewerFindManyArgs= {}>(args?: Subset<T, InterviewerFindManyArgs>): PrismaPromise<Array<InterviewerGetPayload<T>>| Null>;

    JobPost<T extends JobPostFindManyArgs= {}>(args?: Subset<T, JobPostFindManyArgs>): PrismaPromise<Array<JobPostGetPayload<T>>| Null>;
    ...
    Logs<T extends LogsFindManyArgs= {}>(args?: Subset<T, LogsFindManyArgs>): PrismaPromise<Array<LogsGetPayload<T>>| Null>;
  ...
  export type LogsGetPayload<S extends boolean | null | undefined | LogsArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Logs :
    S extends undefined ? never :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends '_count' ? LogsCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : S extends { select: any } & (LogsArgs | LogsFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? LogsCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Logs ? Logs[P] : never
  } 
      : Logs
  ...
  export interface LogsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Logs that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type LogsFindUniqueOrThrowArgs = LogsFindUniqueArgsBase
      

  /**
   * Logs: findFirstOrThrow
   */
  export type LogsFindFirstOrThrowArgs = LogsFindFirstArgsBase
  ...
  export type NotificationMinAggregateOutputType = {
    notificationID: string | null
    notifiactionStatus: notificationStatus | null
    createdAt: Date | null
    userID: string | null
  }
  ...
  export type NotificationGetPayload<S extends boolean | null | undefined | NotificationArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'JobPost' ? JobPostGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'JobPost' ? JobPostGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Notification ? Notification[P] : never
  } 
      : Notification
  ...
  export type ProfileGetPayload<S extends boolean | null | undefined | ProfileArgs, U = keyof S> =
    ...
    ? Profile  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Applicant' ? ApplicantGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Endorsement' ? EndorsementGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Address' ? AddressGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : S extends { select: any } & (ProfileArgs | ProfileFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Applicant' ? ApplicantGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Endorsement' ? EndorsementGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Address' ? AddressGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Profile ? Profile[P] : never
  } 
      : Profile
  ...
  export type AddressGetPayload<S extends boolean | null | undefined | AddressArgs, U = keyof S> =
    ...
    ? Address  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Company_Details' ? CompanyDetailsGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
    ...
    : S extends { select: any } & (AddressArgs | AddressFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Company_Details' ? CompanyDetailsGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Profile' ? ProfileGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Address ? Address[P] : never
  } 
      : Address
  ...
  export type CompanyGetPayload<S extends boolean | null | undefined | CompanyArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    ? Company  & {
    [P in TrueKeys<S['include']>]:
        P extends 'details' ? CompanyDetailsGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'Endorsement' ? Array < EndorsementGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'jobPost' ? Array < JobPostGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'User' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    : S extends { select: any } & (CompanyArgs | CompanyFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'details' ? CompanyDetailsGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'Endorsement' ? Array < EndorsementGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'jobPost' ? Array < JobPostGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'User' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type CompanyDetailsGetPayload<S extends boolean | null | undefined | CompanyDetailsArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'location' ? AddressGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'location' ? AddressGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof CompanyDetails ? CompanyDetails[P] : never
  } 
      : CompanyDetails
  ...
  export interface CompanyDetailsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one CompanyDetails that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type CompanyDetailsFindUniqueOrThrowArgs = CompanyDetailsFindUniqueArgsBase
      

  /**
   * CompanyDetails: findFirstOrThrow
   */
  export type CompanyDetailsFindFirstOrThrowArgs = CompanyDetailsFindFirstArgsBase
  ...
  export type CommentGetPayload<S extends boolean | null | undefined | CommentArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'Endorsement' ? EndorsementGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Comment ? Comment[P] : never
  } 
      : Comment
  ...
  export type EndorsementGetPayload<S extends boolean | null | undefined | EndorsementArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'Profile' ? ProfileGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends '_count' ? EndorsementCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'Endorse' ? Array < EndorseGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'Profile' ? ProfileGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends '_count' ? EndorsementCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Endorsement ? Endorsement[P] : never
  } 
      : Endorsement
  ...
  export interface EndorsementDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Endorsement that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type EndorsementFindUniqueOrThrowArgs = EndorsementFindUniqueArgsBase
      

  /**
   * Endorsement: findFirstOrThrow
   */
  export type EndorsementFindFirstOrThrowArgs = EndorsementFindFirstArgsBase
  ...
  export type EndorseGetPayload<S extends boolean | null | undefined | EndorseArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'feedback' ? FeedbackGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Company' ? CompanyGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Endorsement' ? EndorsementGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'feedback' ? FeedbackGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Company' ? CompanyGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Endorsement' ? EndorsementGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Endorse ? Endorse[P] : never
  } 
      : Endorse
  ...
  export interface EndorseDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Endorse that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type EndorseFindUniqueOrThrowArgs = EndorseFindUniqueArgsBase
      

  /**
   * Endorse: findFirstOrThrow
   */
  export type EndorseFindFirstOrThrowArgs = EndorseFindFirstArgsBase
  ...
  export type FeedbackGetPayload<S extends boolean | null | undefined | FeedbackArgs, U = keyof S> =
    ...
    ? Feedback  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Endorse' ? EndorseGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : S extends { select: any } & (FeedbackArgs | FeedbackFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Endorse' ? EndorseGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
  ...
  export type InterviewerGetPayload<S extends boolean | null | undefined | InterviewerArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'Applicant' ? ApplicantGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : S extends { select: any } & (InterviewerArgs | InterviewerFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'Applicant' ? ApplicantGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Interviewer ? Interviewer[P] : never
  } 
      : Interviewer
  ...
  export interface InterviewerDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Interviewer that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type InterviewerFindUniqueOrThrowArgs = InterviewerFindUniqueArgsBase
      

  /**
   * Interviewer: findFirstOrThrow
   */
  export type InterviewerFindFirstOrThrowArgs = InterviewerFindFirstArgsBase
  ...
  export type ApplicantGetPayload<S extends boolean | null | undefined | ApplicantArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    ? Applicant  & {
    [P in TrueKeys<S['include']>]:
        P extends 'interviewer' ? InterviewerGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'JobPost' ? JobPostGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'Profile' ? ProfileGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'FileUpload' ? UploadFileGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : S extends { select: any } & (ApplicantArgs | ApplicantFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'interviewer' ? InterviewerGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'JobPost' ? JobPostGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'Profile' ? ProfileGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'FileUpload' ? UploadFileGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Applicant ? Applicant[P] : never
  } 
      : Applicant
  ...
  export interface ApplicantDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Applicant that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type ApplicantFindUniqueOrThrowArgs = ApplicantFindUniqueArgsBase
      

  /**
   * Applicant: findFirstOrThrow
   */
  export type ApplicantFindFirstOrThrowArgs = ApplicantFindFirstArgsBase
  ...
  export type UploadFileGetPayload<S extends boolean | null | undefined | UploadFileArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (UploadFileArgs | UploadFileFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Applicant' ? ApplicantGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof UploadFile ? UploadFile[P] : never
  } 
      : UploadFile
  ...
  export interface UploadFileDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one UploadFile that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type UploadFileFindUniqueOrThrowArgs = UploadFileFindUniqueArgsBase
      

  /**
   * UploadFile: findFirstOrThrow
   */
  export type UploadFileFindFirstOrThrowArgs = UploadFileFindFirstArgsBase
  ...
  export type JobPostSelect = {
    ...
    User?: boolean | UserArgs
    Applicants?: boolean | ApplicantFindManyArgs
  ...
  export type JobPostGetPayload<S extends boolean | null | undefined | JobPostArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'Company' ? CompanyGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'Notification' ? NotificationGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'Applicants' ? Array < ApplicantGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'details' ? JobDetailsGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends '_count' ? JobPostCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : S extends { select: any } & (JobPostArgs | JobPostFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Company' ? CompanyGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'Notification' ? NotificationGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'Applicants' ? Array < ApplicantGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'details' ? JobDetailsGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends '_count' ? JobPostCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof JobPost ? JobPost[P] : never
  } 
      : JobPost
  ...
  export interface JobPostDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one JobPost that matches the filter or throw
     * `NotFoundError` if no matches were found.
  ...
  export class Prisma__JobPostClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Applicants<T extends ApplicantFindManyArgs= {}>(args?: Subset<T, ApplicantFindManyArgs>): PrismaPromise<Array<ApplicantGetPayload<T>>| Null>;
   ...
   */
  export type JobPostFindUniqueOrThrowArgs = JobPostFindUniqueArgsBase
      

  /**
   * JobPost: findFirstOrThrow
   */
  export type JobPostFindFirstOrThrowArgs = JobPostFindFirstArgsBase
  ...
  export type JobDetailsGetPayload<S extends boolean | null | undefined | JobDetailsArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (JobDetailsArgs | JobDetailsFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'JobPost' ? JobPostGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof JobDetails ? JobDetails[P] : never
  } 
      : JobDetails
  ...
  export interface JobDetailsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one JobDetails that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type JobDetailsFindUniqueOrThrowArgs = JobDetailsFindUniqueArgsBase
      

  /**
   * JobDetails: findFirstOrThrow
   */
  export type JobDetailsFindFirstOrThrowArgs = JobDetailsFindFirstArgsBase
  ...
  export type NotificationWhereInput = {
    ...
    notifiactionStatus?: EnumnotificationStatusFilter | notificationStatus
    createdAt?: DateTimeFilter | Date | string
  ...
  export type NotificationScalarWhereWithAggregatesInput = {
    ...
    notifiactionStatus?: EnumnotificationStatusWithAggregatesFilter | notificationStatus
    createdAt?: DateTimeWithAggregatesFilter | Date | string
  ...
  export type EndorseWhereInput = {
    ...
    userUserID?: StringFilter | string
  ...
  export type EndorseScalarWhereWithAggregatesInput = {
    ...
    userUserID?: StringWithAggregatesFilter | string
    companyID?: StringNullableWithAggregatesFilter | string | null
    endorsementID?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type NotificationUpdateInput = {
    ...
    notifiactionStatus?: EnumnotificationStatusFieldUpdateOperationsInput | notificationStatus
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type ProfileCreateInput = {
    ...
    Endorsement?: EndorsementCreateNestedOneWithoutProfileInput
  ...
  export type ProfileUpdateInput = {
    ...
    Endorsement?: EndorsementUpdateOneWithoutProfileNestedInput
  ...
  export type EndorsementCreateInput = {
    ...
    Profile?: ProfileCreateNestedOneWithoutEndorsementInput
  }
  ...
  export type EndorsementUncheckedCreateInput = {
    ...
    Profile?: ProfileUncheckedCreateNestedOneWithoutEndorsementInput
  }
  ...
  export type EndorsementUpdateInput = {
    ...
    Profile?: ProfileUpdateOneWithoutEndorsementNestedInput
  }
  ...
  export type EndorsementUncheckedUpdateInput = {
    ...
    Profile?: ProfileUncheckedUpdateOneWithoutEndorsementNestedInput
  }
  ...
  export type EndorseCreateInput = {
    ...
    feedback?: FeedbackCreateNestedOneWithoutEndorseInput
    Company?: CompanyCreateNestedOneWithoutEndorseInput
    Endorsement?: EndorsementCreateNestedOneWithoutEndorseInput
  }
  ...
  export type EndorseUncheckedCreateInput = {
    ...
    endorseStatus?: endorseStatus
    userUserID: string
    feedback?: FeedbackUncheckedCreateNestedOneWithoutEndorseInput
    companyID?: string | null
    endorsementID?: string | null
  }
  ...
  export type EndorseUpdateInput = {
    ...
    feedback?: FeedbackUpdateOneWithoutEndorseNestedInput
    Company?: CompanyUpdateOneWithoutEndorseNestedInput
    Endorsement?: EndorsementUpdateOneWithoutEndorseNestedInput
  }
  ...
  export type EndorseUncheckedUpdateInput = {
    ...
    feedback?: FeedbackUncheckedUpdateOneWithoutEndorseNestedInput
    companyID?: NullableStringFieldUpdateOperationsInput | string | null
    endorsementID?: NullableStringFieldUpdateOperationsInput | string | null
  }
  ...
  export type EndorsementCreateNestedOneWithoutProfileInput = {
    create?: XOR<EndorsementCreateWithoutProfileInput, EndorsementUncheckedCreateWithoutProfileInput>
    connectOrCreate?: EndorsementCreateOrConnectWithoutProfileInput
  ...
  export type EndorsementUpdateOneWithoutProfileNestedInput = {
    create?: XOR<EndorsementCreateWithoutProfileInput, EndorsementUncheckedCreateWithoutProfileInput>
    connectOrCreate?: EndorsementCreateOrConnectWithoutProfileInput
    upsert?: EndorsementUpsertWithoutProfileInput
    disconnect?: boolean
    delete?: boolean
    connect?: EndorsementWhereUniqueInput
    update?: XOR<EndorsementUpdateWithoutProfileInput, EndorsementUncheckedUpdateWithoutProfileInput>
  }
  ...
  export type EndorseCreateNestedManyWithoutEndorsementInput = {
    ...
    createMany?: EndorseCreateManyEndorsementInputEnvelope
    connect?: Enumerable<EndorseWhereUniqueInput>
  }

  export type ProfileCreateNestedOneWithoutEndorsementInput = {
    create?: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
    connectOrCreate?: ProfileCreateOrConnectWithoutEndorsementInput
    connect?: ProfileWhereUniqueInput
  }
  ...
  export type ProfileUncheckedCreateNestedOneWithoutEndorsementInput = {
    create?: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
    connectOrCreate?: ProfileCreateOrConnectWithoutEndorsementInput
    connect?: ProfileWhereUniqueInput
  }
  ...
  export type ProfileUpdateOneWithoutEndorsementNestedInput = {
    create?: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
    connectOrCreate?: ProfileCreateOrConnectWithoutEndorsementInput
    upsert?: ProfileUpsertWithoutEndorsementInput
    disconnect?: boolean
    delete?: boolean
    connect?: ProfileWhereUniqueInput
    update?: XOR<ProfileUpdateWithoutEndorsementInput, ProfileUncheckedUpdateWithoutEndorsementInput>
  }
  ...
  export type ProfileUncheckedUpdateOneWithoutEndorsementNestedInput = {
    create?: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
    connectOrCreate?: ProfileCreateOrConnectWithoutEndorsementInput
    upsert?: ProfileUpsertWithoutEndorsementInput
    disconnect?: boolean
  ...
  export type FeedbackCreateNestedOneWithoutEndorseInput = {
    create?: XOR<FeedbackCreateWithoutEndorseInput, FeedbackUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: FeedbackCreateOrConnectWithoutEndorseInput
    connect?: FeedbackWhereUniqueInput
  }
  ...
  export type EndorsementCreateNestedOneWithoutEndorseInput = {
    create?: XOR<EndorsementCreateWithoutEndorseInput, EndorsementUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: EndorsementCreateOrConnectWithoutEndorseInput
    connect?: EndorsementWhereUniqueInput
  }

  export type FeedbackUncheckedCreateNestedOneWithoutEndorseInput = {
    create?: XOR<FeedbackCreateWithoutEndorseInput, FeedbackUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: FeedbackCreateOrConnectWithoutEndorseInput
    connect?: FeedbackWhereUniqueInput
  }
  ...
  export type FeedbackUpdateOneWithoutEndorseNestedInput = {
    create?: XOR<FeedbackCreateWithoutEndorseInput, FeedbackUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: FeedbackCreateOrConnectWithoutEndorseInput
    upsert?: FeedbackUpsertWithoutEndorseInput
    disconnect?: boolean
    delete?: boolean
    connect?: FeedbackWhereUniqueInput
  ...
  export type EndorsementUpdateOneWithoutEndorseNestedInput = {
    create?: XOR<EndorsementCreateWithoutEndorseInput, EndorsementUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: EndorsementCreateOrConnectWithoutEndorseInput
    upsert?: EndorsementUpsertWithoutEndorseInput
    disconnect?: boolean
    delete?: boolean
    connect?: EndorsementWhereUniqueInput
  ...
  export type FeedbackUncheckedUpdateOneWithoutEndorseNestedInput = {
    create?: XOR<FeedbackCreateWithoutEndorseInput, FeedbackUncheckedCreateWithoutEndorseInput>
    connectOrCreate?: FeedbackCreateOrConnectWithoutEndorseInput
    upsert?: FeedbackUpsertWithoutEndorseInput
    disconnect?: boolean
  ...
  export type EndorsementCreateWithoutProfileInput = {
    endorsementID?: string
    email: string
    Status: string
    createdAt: Date | string
  ...
  export type EndorsementUncheckedCreateWithoutProfileInput = {
    endorsementID?: string
    email: string
    Status: string
    createdAt: Date | string
  ...
  export type EndorsementCreateOrConnectWithoutProfileInput = {
    where: EndorsementWhereUniqueInput
    create: XOR<EndorsementCreateWithoutProfileInput, EndorsementUncheckedCreateWithoutProfileInput>
  }
  ...
  export type EndorsementUpsertWithoutProfileInput = {
    update: XOR<EndorsementUpdateWithoutProfileInput, EndorsementUncheckedUpdateWithoutProfileInput>
    create: XOR<EndorsementCreateWithoutProfileInput, EndorsementUncheckedCreateWithoutProfileInput>
  }

  export type EndorsementUpdateWithoutProfileInput = {
    endorsementID?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    Status?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type EndorsementUncheckedUpdateWithoutProfileInput = {
    endorsementID?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    Status?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type EndorseCreateManyEndorsementInputEnvelope = {
    data: Enumerable<EndorseCreateManyEndorsementInput>
    skipDuplicates?: boolean
  }

  export type ProfileCreateWithoutEndorsementInput = {
    profileID?: string
    firstname: string
    lastname: string
    phone: string
  ...
  export type ProfileUncheckedCreateWithoutEndorsementInput = {
    profileID?: string
    firstname: string
    lastname: string
    phone: string
  ...
  export type ProfileCreateOrConnectWithoutEndorsementInput = {
    where: ProfileWhereUniqueInput
    create: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
  }
  ...
  export type ProfileUpsertWithoutEndorsementInput = {
    update: XOR<ProfileUpdateWithoutEndorsementInput, ProfileUncheckedUpdateWithoutEndorsementInput>
    create: XOR<ProfileCreateWithoutEndorsementInput, ProfileUncheckedCreateWithoutEndorsementInput>
  }

  export type ProfileUpdateWithoutEndorsementInput = {
    profileID?: StringFieldUpdateOperationsInput | string
    firstname?: StringFieldUpdateOperationsInput | string
    lastname?: StringFieldUpdateOperationsInput | string
    phone?: StringFieldUpdateOperationsInput | string
  ...
  export type ProfileUncheckedUpdateWithoutEndorsementInput = {
    profileID?: StringFieldUpdateOperationsInput | string
    firstname?: StringFieldUpdateOperationsInput | string
    lastname?: StringFieldUpdateOperationsInput | string
    phone?: StringFieldUpdateOperationsInput | string
  ...
  export type FeedbackUpsertWithoutEndorseInput = {
    update: XOR<FeedbackUpdateWithoutEndorseInput, FeedbackUncheckedUpdateWithoutEndorseInput>
    create: XOR<FeedbackCreateWithoutEndorseInput, FeedbackUncheckedCreateWithoutEndorseInput>
  }
  ...
  export type EndorsementUpsertWithoutEndorseInput = {
    update: XOR<EndorsementUpdateWithoutEndorseInput, EndorsementUncheckedUpdateWithoutEndorseInput>
    create: XOR<EndorsementCreateWithoutEndorseInput, EndorsementUncheckedCreateWithoutEndorseInput>
  }
  ...
  export type EndorseCreateManyEndorsementInput = {
    endorseID?: string
    endorseStatus?: endorseStatus
    userUserID: string
    companyID?: string | null
